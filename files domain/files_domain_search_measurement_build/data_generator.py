...
class Data(object):
    ...
    def __init__(self):
        ...
        self.domain_slot_process['PEOPLE'].add('people_attribute')
        self.domain_slot_process['TEAMSMESSAGE'].add('keyword')
        self.domain_slot_process['EMAIL'].add('email_subject')
        self.domain_slot_process['EMAIL'].add('message')
        self.domain_slot_process['EMAIL'].add('keyword')
        self.domain_slot_process['NOTE'].add('note_text')
        self.domain_slot_process['REMINDER'].add('reminder_text')
...
data.write_data(data_filename='fileSearchMeasurement.tsv', keylist_filename='filekeys_chiecha.txt')
