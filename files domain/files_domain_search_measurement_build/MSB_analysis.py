...
data_files = glob('./msb_nrgative_data/*maxeqeqeqnt.output.txt')
#data_files = glob('./msb_nrgative_data/*maxent.output.tsv')
...
df_trigger = df.loc[df[1] >= 0.35]
df_notrigger = df.loc[df[1] < 0.35]

print("df trigger {}".format(df_trigger))
print("df notrigger {}".format(df_notrigger))
