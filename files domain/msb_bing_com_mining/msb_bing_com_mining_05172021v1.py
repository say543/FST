...
# function to filter
def ngrams_compound_heurictic(xgram, filetypeIncludeBoost, verbs):
...
# apply heurisstic
#=======================
xgram_cnt_sort_by_cnt = ngrams_compound_heurictic(xgram_cnt_sort_by_cnt, filetypeIncludeBoost, verbs)
