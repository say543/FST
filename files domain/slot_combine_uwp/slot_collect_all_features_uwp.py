...
#creating trainnig file for uwp
#outputFile = 'files_slot_training.tsv'
outputFile = 'files_slot_training_uwp.tsv'

# replace directly
#outputTrainingFolderFile = '..\\files_slot_training.tsv'
outputTrainingFolderFile = '..\\files_slot_training_uwp.tsv'
# for STCA test
#outputSTCATrainingFolderFile = '..\\sharemodeltest\\files_slot_training.tsv'
outputSTCATrainingFolderFile = '..\\sharemodeltest\\files_slot_training_uwp.tsv'

#outputFileWithSource = "files_slot_training_with_source.tsv"
outputFileWithSource = "files_slot_training_uwp_with_source.tsv"
#dsatTraining = "dsat_training.tsv"
dsatTraining = "dsat_training_uwp.tsv"
...
copyfile("..\\dsat_training_uwp.tsv" , "dsat_training_uwp.tsv")
