...
#inputFile = "Reporting_Teams_AllDomain_SR_RandomSampling_20191101-20191130_10k.tsv"
#inputFile = "Reporting_Teams_AllDomain_SR_RandomSampling_20191201-20192131_7k.tsv"
...
with codecs.open(inputFile, 'r', 'utf-8') as fin:
    ...
    for line in fin:
        ...
        # including all domains inorder to build measurement set
        #if linestrs[6] != 'FILES':
        #    continue
