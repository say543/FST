...
with torch.no_grad():
    ...
    slot_output) = model(test_input_tensor, attention_mask=at_mask_tensor, labels=label_mask_tensor)

    # if gonig wtih sinlge output and evaluation no labels being provided
