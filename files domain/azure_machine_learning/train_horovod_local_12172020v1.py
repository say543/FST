...
#local installed and import for debug
from transformers import DistilBertTokenizer
...
#https://github.com/deepset-ai/FARM/issues/233
...
for text in texts:
    ...
    tokenizer.encode(text, max_length=300, pad_to_max_length=True, truncation=True)
