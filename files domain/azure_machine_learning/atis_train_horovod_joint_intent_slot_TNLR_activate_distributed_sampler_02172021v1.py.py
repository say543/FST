...
###############
#remote training data setup in learning below - with ramdom sampler
###############
...
###############
#remote training data setup in learning above - with ramdom sampler
###############
...
if hvd.rank() == 0:
    ...
    # remote does not need to do this but not sure why
    #import os, argparse
