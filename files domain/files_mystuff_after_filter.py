...
blackListQuerySet = {
    ...
    "Load store merchandising photos for XYZ Company.",
    "check errands list for sat. and sun.",
    "did I add gluten free items to the birthday party menu list?",
    "show me the current lists that i have for shopping, holidays and travel",
    "do you my current task list",
    "open notepad file list",
    "Sat and Sun need to chk on my errands list.",
    "what is on my bucket list",
    "guest list edit",
    "What's on my bills list?",
    "What's on the Costco list?",
    "What's on my Costco list?",
    "What's on my packing list?",
    "What's on my planning list?",
    "What's on my New York best New York Times bestseller list?",
    "What's on my Home Depot list?",
    "What's on my Edgewood list?",
    "What's in my Dollar store list?",
    "What is on dog stuff list?",
    "What's tax on the Trader Joe's list?",
    "What's on my travel list?",
    "What's on my mind for Thanksgiving list?",
    "What's on my test list?",
    "I would like you to make changes in the idea list.",
    "What's on my picnic shopping list",
    "Are Cortana list on OneDrive?",
    "list all my stock list",
    "What's on my moms plants list?",
    "What is on my food giant shopping list?",
    "What are the items on my up North list?",
    "What is on my food giant shopping list?",
    "What are the items on the Costco list?",
    "sharepoint task list",
    "What's on my task list?",
    "What's on my HP list?",
    "What is on my reminder list?",
    "What is on my supplies for the party list?",
    "What's on my associated buyers list?",
    "What's on my associated buyers list?",
    "What's on my associated buyers list?",
    "What's on my associated buyers list?",
    "What's on my associated buyers list?",
    "What's on my movies list?",
    "what is on my weekend camping list?",
    ...
    "What's on my associated buyers list?",
    "what is on my weekend camping list?",
    "What is on my Espresso list?",
    "who's on my birthday list",
    "where's my i gotta have it list",
    "where's my i gotta have it list",
    "Where is my saved business list?",
    "where is my favorite list",
    "Where is my burn list",
    "were do i find my reminder list",
    "onedrive search for shopping lists",
    "notes about fire list them",
    "best selling list twenty fifteen",
    "Find all work lists",
    "List my Task List from yesterday",
    "Cortana, where is Soccer Practice Call List I saved last month?",
    "find holiday list complete buy suncream",
