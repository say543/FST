...
# if including extra negative data from kashan, using this one
#data.load_negative_data('negative_corpus.txt', 'additional_neg_data_in_query_form.txt')
# if including extra negative data from yourself, using this one
##data.load_negative_data('negative_corpus.txt', 'additional_neg_data_in_query_form_chiecha.txt')
data.load_negative_data('negative_intent_corpus.txt', 'additional_intent_neg_data_in_query_form_chiecha.txt')
#data.load_negative_data('negative_corpus_1.txt', 'additional_neg_data_in_query_form_chiecha.txt')
...
# for intent, no read all_patterns_files = glob('./patterns/*.txt')
