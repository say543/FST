...
inputFile1 = "files_domain_training_answer_checkin.tsv"
inputFile2 = "files_domain_training_answer.tsv"
...
with codecs.open((inputFile1.split("."))[0] +'_sort'+'.tsv', 'w', 'utf-8') as fout:
    # header
    fout.write("TurnNumber\tPreviousTurnIntent\tquery\tdomain\tPreviousTurnDomain\tTaskFrameStatus\tTaskFrameEntityStates\tTaskFrameGUID\tSpeechPeopleDisambiguationGrammarMatches\tConversationalContext")
    for item in output1:
        fout.write(item + '\r\n');
