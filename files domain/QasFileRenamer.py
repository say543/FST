...
if __name__ == '__main__':
    ...
    #cmd = ("-s ..\\output_domain_answer_05142020v2_use_pcfg_v3_domain_cut_some_uesless_domains_negative_cases\\domain_svm\\final -t replaced -r files_enus_mv1:files_enus_mv2").split()
    ...
    #cmd = ("-s ..\\output_domain_answer_05192020v1_use_pcfg_v3_domain_cut_some_uesless_domains_negative_cases\\domain_svm\\final -t replaced -r files_enus_mv1:files_enus_mv2").split()


    #cmd = ("-s ..\\output_adhoc_slot_05192020v1\\slot_lccrf\\final -t replaced -r files_enus_mv1:files_enus_mv2").split()
