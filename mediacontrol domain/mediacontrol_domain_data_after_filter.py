...
# this affect mystuff and ondevice
blackListQuerySet = {
    # regular group
    #excel
    'excel',
    ...
    # play xxx,  mystuff will be remove
    "Play word on blood exit.",
    "Play powerpoint presentation",
    "Play powerpoint presentation",
    "Play powerpoint presentation",
    "Play powerpoint presentation",
    "Play powerpoint presentation",
    "Play power point slide from Sam.",
    "Play the video file that's on my desktop",
    "Play PowerPoint.",
    "Play Cortana find the documents I did yesterday",
    "Play blank word doc",
    "Play the slide show of pictures",
    "Play PowerPoint",
    "Play pm file of type xlsx",
    "Play Deck Demand",
    "Play pm file of type OneNote",
    "Play powerpoint presentation",
    "Play powerpoint presentation",
    "Play powerpoint presentation",
    "Play powerpoint presentation",
    "Play new product presentation",
    "Play powerpoint presentation",
    # open word for me, ondevice so negative examples, mystuff will be remove
    # in teams using pattern to cover
    'Can you open word for me?',
    'Open word for me',
    'open word for me',
    'Can you please open word for me',
    'Open word for me',
    'Open word for me please',
    'Open word for me please',
    'Open word for me.',
    'Can you open word for me',
    'Can you please open word for me',
    'could you open word for me',
    'can you please open word for me',
    'can you please open word for me',
    'hey cortana open word for me please',
    'cortana open word for me',
    'can you open word for me please',
    'can you open word for me please',
    'hey cortana could you open word for me please',
    'please open word for me',
    'hey cortana can you open word for me',
    'hey cortana can you open word for me',
    # clost xxx, ondevice so negative examples, mystuff will be remove
    "close onenote",
    "close word",
    "close excel",
    "close onenote",
    ...
    "close excel",
    "close excel",
    "close excel two thousand thirteen",
    "close onenote",
    "close word",
    "close excel",
    "close word",
    "close excel",
    "close PowerPoint and save",
    "close excel",
    "close word",
    "close all open files on this computer",
    "close excel",
    ...
    "close word",
    "close excel",
    "close powerpoint twenty fourteen",
    "close word",
    "close excel",
    "close onenote",
    "close word pad",
    ...
    "close powerpoint",
    "close excel",
    "close word two thousand and thirteen",
    "close onenote",
    "close powerpoint",
    "close word",
    "close powerpoint",
    ...
    "close onenote",
    "close word",
    'close the "Wtf is this" OneNote',
    "close word",
    "close excel",
    "close powerpoint",
    "close excel",
    "close excel",
    "close my word document",
    "close OneNote.",
    "close word",
    "close file",
    "close word",
    "close onenote",
    "close word twenty sixteen",
    "close onenote",
    "close internet excel",
    "close open PDF",
    "close excel",
    "close onenote",
    "close word",
    ...
    "close word",
    "close powerpoint",
    "close powerpoint twenty sixteen",
    "close word",
    "close excel",
    "close onenote",
    "close word",
    "close onenote",
    'close the PDF "Steps to be successful from Liam',
    "close word",
    "close onenote",
    "close excel two thousand and thirteen",
    "close word",
    "close file echo",
    "close excel",
    "close onenote",
    "close words with friends",
    "close powerpoint",
    "close excel",
    "close word",
    "close onenote",
    ...
    "close excel",
    "close onenote",
    'close the Excel Sheet named "Bills" from Mariah',
    "close word",
    "close onenote",
    "close file",
    "close pdf reader",
    "close onenote two thousand thirteen",
    "close onenote",
    "close word",
    "close word",
    "close excel",
    ...
    "close word",
    "close excel",
    'Please close Microsoft PowerPoint and Microsoft',
    'can you close onenote',
    'can you close onenote',
    'hey cortana close excel',
    'hey cortana close excel',
    'hey cortana close excel',
    'hey cortana close excel',
    'hey cortana close excel',
    ...
    'hey cortana close excel',
    'hey cortana close excel',
    "shouldn't have closed it open onenote shut up",
    'hey cortana close excel',
    'hey cortana close excel',
    'hey cortana close excel',
    'how do i close onenote',
    'hey cortana close word for me please',
    'hey cortana close word',
    'hey cortana close word',
    'hey cortana close word',
    'hey cortana close word',
    'hey cortana close word',
    ...
    'hey cortana close word',
    'hey cortana close word',
    'cortana close onenote',
    'cortana close onenote',
    'cortana close onenote',
    'cortana close onenote',
    'cortana close excel',
    'cortana close excel',
    'hey cortana close powerpoint twenty sixteen',
    'hey cortanna close excel',
    'hey cortanna close onenote',
    'hey cortana close word mobile',
    'ok you can close word now',
    'hey contana close word',
    'hey cortana close onenote two thousand thirteen',
    'hey cortana can you close word',
    'yes hey cortana close powerpoint',
    'hey cortana close powerpoint',
    'hey cortana close powerpoint',
    'hey cortana close powerpoint',
    'hey cortana close powerpoint',
    'hey cortana close powerpoint',
    ...
    'hey cortana close powerpoint',
    'hey cortana close powerpoint',
    'can you close excel please',
    'hey cortana close excel down',
    'hey cortana close word two thousand sixteen preview',
    'cortana close word',
    'hey cortana close word two thousand and sixteen',
    'hey cortana close word two thousand and sixteen',
    'hey cortana close word two thousand and sixteen',
    'hey cortana can you close excel for me',
    'hey cortana close onenote',
    'hey cortana close onenote',
    'hey cortana close onenote',
    'hey cortana close onenote',
    'hey cortana close onenote',
    ...
    'hey cortana close onenote',
    'cantana close word',
    'cortana close powerpoint',
    'hey cortana close budget xls',
    'hey cortana can you close the documents',
    'hey cortana close all files',
    'i close off the powerpoint',
    'hey cortana close all word documents',
    'Siri, Close "Things to buy" Docs from Mia',
    'hey cortana close all documents',
    'hey cortana close document',
    # screenshot, mystuff so will disappear
    'show me the files screenshot',
    'Cortana show me my screenshots in file',
    'open the file where my screenshots go',
    'Cortana show me my screenshots in file',
    # file a bug, most from ondevice so negative examples
    "hey cortana file a bug using the",
    "hey cortana file a bug using feedback hub",
    "file a bug",
    "hey cortana file a bug and going through",
    "File a bug.",
    "hey cortana feedback hub file a bug",
    "File a bug.",
    "file a bug",
    "File a bug.",
    "hey cortana file a bug with the feedback hub",
    "file a bug",
    "How do I file a bug with Microsoft?",
    "File a bug.",
    "file a bug",
    "hey cortana file a bug using feedback hub",
    "file a bug",
    "file a bug",
    # resume, mystuff so will disappear
    "resume PowerPoint from Sheila",
    "resume docs from Ecuador",
    "resume word",
    "resume document",
    "resume doc",
    "resume visio doc from Monica",
    "Resume document",
    # should wrong files query
    'Should come up excel',
    "shouldn't have closed it open onenote shut up",
    "open onenote yeah we should maybe"
    }
