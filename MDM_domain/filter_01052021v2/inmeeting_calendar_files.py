...
for file in data_files[:]:
    ...
    'MessageId': object, 'Frequency': object, 'ConversationContext': object, 'SelectionIgnore': object})
        ...
        #update_df['SelectionIgnore'] = update_df['SelectionIgnore'].replace(['1.0'],'1')
        ...
        # add more dataset in the future
        if filebasename == 'Mustpass_Default_Calendar_DSAT.tsv' or filebasename == 'Mustpass_Default_Calendar_Golden.tsv':
            copyfile(filebasename, "E:\\CoreScienceDataStaging\\datasets\\Default\\Test"+"\\"+filebasename)
        elif filebasename =='Mustpass_TVS_AllDomain_ManualTest_BVT.tsv':
            copyfile(filebasename, "E:\\CoreScienceDataStaging\\datasets\\TeamsVoiceSkills\\Test\\Official"+"\\"+filebasename)
        else:
            copyfile(filebasename, "E:\\CoreScienceDataStaging\\datasets\\TeamsVoiceSkills\\Train"+"\\"+filebasename)
